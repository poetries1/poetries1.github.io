(function() {
	...
	// 绘制3环上的CSS
	var L3_CircleText_CSS = new CircleText({
		x: outerRadius * Math.cos(72 * Math.PI / 180),
		y: outerRadius * Math.sin(72 * Math.PI / 180),
		innerRadius: 43, //内圆半径
		outerRadius: 48, //外圆半径
	...
	L3_CircleText_CSS.addToGroupOrLayer(L3_group);

	//绘制3环上的 JS圆形组
	var L3_CircleText_JS = new CircleText({
		x: outerRadius * Math.cos(144 * Math.PI / 180),
		y: outerRadius * Math.sin(144 * Math.PI / 180),
		innerRadius: 40, //内圆半径
		outerRadius: 45, //外圆半径
	...
	var L3_CircleText_JQUERY = new CircleText({
		x: outerRadius * Math.cos(216 * Math.PI / 180),
		y: outerRadius * Math.sin(216 * Math.PI / 180),
		innerRadius: 35, //内圆半径
		outerRadius: 38, //外圆半径
		innerStyle: '#E9EF5C', //内圆的填充样式
	...
	//绘制3环上的 bootstrap圆形组
	var L3_CircleText_BOOTSTRAP = new CircleText({
		x: outerRadius * Math.cos(284 * Math.PI / 180),
		y: outerRadius * Math.sin(284 * Math.PI / 180),
		innerRadius: 40, //内圆半径
		outerRadius: 45, //外圆半径
